...
try{
   $bdd = new PDO('mysql:host=localhost;dbname=demo_cartes;charset=utf8', 'CHIMIEcommande_A', 'T6sCReBj');
	//$bdd = new PDO('mysql:host=localhost;dbname=CHIMIEcommande;charset=utf8', 'CHIMIEcommande_A', 'T6sCReBj');
	//$bdd = new PDO('mysql:host=localhost;dbname=mverot;charset=utf8', 'mverot', 'vcR95oWTh');
}catch (Exception $e){
        die('Erreur : ' . $e->getMessage());
}
//ENTER THE MAIL OF THE CONTACT PERSON FOR PASSWORD RECOVERY
$mail_sender=array("name"=>'Martin Vérot',"mail"=>"martin.verot@ens-lyon.fr");
